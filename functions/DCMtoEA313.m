function [theta1,theta2,theta3] = DCMtoEA313(C)
% DCMtoEA323 computes the (3-1-3) sequence of Euler angles from the DCM.
%
% Inputs:
...
% first Euler angle
theta1 = atan2(C(3,1),-C(3,2)); % [rad]

% second Euler angle
theta2 = acos(C(3,3)); % [rad]

% third Euler angle
theta3 = atan2(C(1,3),C(2,3)); % [rad]
